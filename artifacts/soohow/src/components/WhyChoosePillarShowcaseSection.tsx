...
export function WhyChoosePillarShowcaseSection({ pillarIndex }: Props) {
  ...
  const sectionPadding =
    pillarIndex === 0
      ? "pt-4 md:pt-6 pb-14 md:pb-16"
      : "pt-8 md:pt-10 pb-16 md:pb-20";

  return (
    <section
      ref={sectionRef}
      id={config.sectionId}
      className={`relative ${sectionPadding} border-t site-border overflow-hidden site-home-section pillar-showcase-section scroll-mt-20 md:scroll-mt-[5.5rem]`}
          ...
          >
            ...
            >
              <div className="relative z-10">
                ...
                <h2 className="site-section-title text-left mb-5 max-w-3xl">
                  {pillar.title}
                </h2>
