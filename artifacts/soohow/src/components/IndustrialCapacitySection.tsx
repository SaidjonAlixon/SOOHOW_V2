        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-10 xl:gap-12 items-start mb-14 md:mb-16">
          ...
          >
            ...
            <div className="md:pl-6 md:border-l-2 border-[#00A8E8]/35">
              ...
              <h2 className="font-heading font-bold text-[clamp(1.75rem,4.2vw,3rem)] leading-[1.15] tracking-tight max-w-3xl">
                <span className="block bg-gradient-to-r from-[#00A8E8] via-[#00D4AA] to-[#0077a8] dark:to-[#5dd4ff] bg-clip-text text-transparent">
                  {t("industrial.title")}
                </span>
              </h2>
