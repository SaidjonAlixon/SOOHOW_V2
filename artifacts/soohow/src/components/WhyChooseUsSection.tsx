        ...
        <motion.div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-stretch">
          ...
          >
            <div className="absolute inset-0 grid grid-cols-2 grid-rows-2 gap-1 p-1 bg-[hsl(var(--site-border)/0.4)] h-full min-h-[inherit]">
              <div className="relative col-span-1 row-span-2 overflow-hidden rounded-lg h-full min-h-0">
                <img
              ...
              <div className="relative overflow-hidden rounded-lg h-full min-h-0">
                <img
            ...
            <div className="absolute bottom-0 right-0 left-0 p-6 md:p-8 flex justify-end">
              <div className="text-right backdrop-blur-sm bg-[hsl(var(--site-card)/0.85)] dark:bg-[hsl(var(--site-card)/0.75)] border site-border rounded-xl px-5 py-4 shadow-lg">
