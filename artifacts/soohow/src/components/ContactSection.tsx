              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <FormField control={form.control} name="name" render={({ field }) => (
                    <FormItem><FormControl><Input placeholder={t('contact.formName')} className="site-form-control" {...field} /></FormControl><FormMessage /></FormItem>
                  )} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <FormField control={form.control} name="email" render={({ field }) => (
                    <FormItem><FormControl><Input placeholder={t('contact.formEmail')} className="site-form-control" {...field} /></FormControl><FormMessage /></FormItem>
                  )} />
                  <FormField control={form.control} name="subject" render={({ field }) => (
                    <FormItem>
                      <FormControl>
                        ...
                        >
                          <SelectTrigger className="site-form-control">
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent className="z-[3100] border site-border bg-[hsl(var(--site-card))] text-[hsl(var(--site-fg))] shadow-xl">
                            {messages.contact.subjects.map((subject) => (
                              <SelectItem
                                key={subject}
                                value={subject}
                                className="cursor-pointer text-[hsl(var(--site-fg))] focus:bg-[#00A8E8]/15 focus:text-[hsl(var(--site-fg))] data-[highlighted]:bg-[#00A8E8]/15 data-[highlighted]:text-[hsl(var(--site-fg))]"
                              >
                                {subject}
                              </SelectItem>
                            ))}
